...
The used profanity words can be inspected [in this Github Repository](https://github.com/alfords/jhudsproject/blob/master/profanityfilter.txt).
...
All used code snippets to generate this report can be viewed in this [repository](https://github.com/alfords/jhudsproject/blob/master/MilestoneReport.Rmd).
